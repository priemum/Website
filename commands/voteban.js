...
module.exports.run = async (client, message, args, guild) => {
    ...
    if (user === message.author) return message.reply("No"); 
        ...
        let e = new MessageEmbed()
            ...
            .setDescription('Your bot has been flagged for API or Vote Count Abuse, Please contact a Staff Member for assistance.')
            .addField("Mod", message.author, true)
            .addField("Note:", "Your bot will not be able to recieve votes until this issue is resolved")
            .setTimestamp()
            .setColor(0x26ff00)
