    ...
    message.delete().catch()
        ...
        if (roleToSub === 'updates') {
            let successEmbed = new MessageEmbed()
                ...
                successEmbed.setDescription('You have subscribed for Server, Website and API Updates.')
          ...
          let successEmbed = new MessageEmbed()
                successEmbed.setTitle('Subscription Successful')
                successEmbed.setColor('#7289DA')
                successEmbed.setDescription('You have subscribed for Updates regarding our Staff Applications')
                successEmbed.setTimestamp()
