...
module.exports.run = async (client, message, args) => {
    ...
    if (!message.member.hasPermission('MANAGE_MESSAGES', 'ADMINISTRATOR')) {
        ...
        noPerms.setDescription(`<@${message.author.id}> You didn't provide an amount`);
        ...
        if (!args[0]) {
            ...
            noAmount.setDescription(`<@${message.author.id}> You didn't provide an amount`);
            noAmount.setTimestamp()
            noAmount.setFooter('© Paradise Bots | 2020', 'https://i.imgur.com/Df2seyl.png')
            ...
            clearDone.setFooter('© Paradise Bots | 2020', 'https://i.imgur.com/Df2seyl.png')
