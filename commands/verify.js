...
if(!reason) return message.reply('Please provide a reason and or feedback.')
...
message.guild.members.fetch(message.client.users.cache.find(u => u.id === botToVerify.owner)).then(botOwner => {
