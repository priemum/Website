...
module.exports.run = async (client, message, args) => {
  ...
  message.delete().catch()
   ...
   let embed = new MessageEmbed()
      ...
      .addField('API version:', `v1.0.8 | [Change Log](https://docs.paradisebots.net/changelog/api/Paradise-API-v1.0.8/)`, true)
      .addField('Bot version:', `v2.1.0| [Change Log](https://docs.paradisebots.net/changelog/bot/Paradise-Bot-v2.10/)`, true)
      .addField('Website version:', `v2.2.0 | [Change Log](https://docs.paradisebots.net/changelog/site/Paradise-v2.2.0/ )`, true)
