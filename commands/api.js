...
module.exports.run = async (client, message, args) => {
    ...
    try {
        ...
        var apiMessage = new MessageEmbed()
            ...
            apiMessage.addField('NPM Module', '[Click Here](https://www.npmjs.com/package/paradiseapi.js)', true)
            apiMessage.addField('Python Wrapper', '[Click Here](https://gist.github.com/Aryamaan08/6833f31218b00f7792dc900728b0db01)', true)
            apiMessage.addField('API Docs', '[Click Here](https://paradisebots.net/api/v1/docs)', true)
            apiMessage.addField('Paradise Docs', '[Click Here](https://docs.paradisebots.net)', true)
