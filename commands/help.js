...
module.exports.run = async (client , message, args) => {
  ...
  try {
    ...
    let prefix = "p>"
            ...
            sent.setDescription(`<@${message.author.id}> Commands have been sent, Please check your DMs.`)
            sent.setTimestamp()
            ...
            hiddenSent.setFooter('© Paradise Bots | 2020', 'https://i.imgur.com/Df2seyl.png')

            const cant = new MessageEmbed()
            cant.setAuthor('Whoops, Error', 'https://i.imgur.com/Df2seyl.png')
            cant.setDescription('Please make sure you are allowing DMs from Server Members.')
            cant.setTimestamp()
    ...
    const embed = new MessageEmbed()
          ...
          embed.addField('Full List', '[Commands List](https://paradisebots.net/bots/727779650738323497)')
          embed.addField('Available Modules', '• approvers - Commands for our Approvers!! \n• info - Information and Help commands. \n• fun - Fun commands.\n• memes - Meme commands.\n• mod - Moderation commands.\n• list - Commands used to interact with our Bot List.')
          embed.setTimestamp()
          embed.setFooter('© Paradise Bots | 2020', 'https://i.imgur.com/Df2seyl.png')

    const embed2 = new MessageEmbed()
          embed2.setAuthor('Paradise Help Command | Approvers', 'https://i.imgur.com/Df2seyl.png')
          embed2.addField('Approver Only', '• p>trusted - Commands locked to Approvers/Trusted Members')
          embed2.addField('Dev Note', 'You have been DMed this message because it contains a command module that is Locked and unavailable to Normal Members')
          embed2.setTimestamp()
          embed2.setFooter('© Paradise Bots | 2020', 'https://i.imgur.com/Df2seyl.png')
        ...
        return message.channel.send(embed)
          ...
          if (args[0] === 'approvers') {
            ...
            const embed3 = new MessageEmbed()
                  ...
                  embed3.setTimestamp()
                  embed3.setFooter('© Paradise Bots | 2020', 'https://i.imgur.com/Df2seyl.png')

                  message.author.send(embed3).then(() => message.channel.send(sent)).catch(() => message.channel.send(cant))
            ...
            const embed4 = new MessageEmbed()
                  ...
                  embed4.setTimestamp()
                  embed4.setFooter('© Paradise Bots | 2020', 'https://i.imgur.com/Df2seyl.png')

                  message.author.send(embed4).then(() => message.channel.send(sent)).catch(() => message.channel.send(cant))
            ...
            embed5.setTimestamp()
            embed5.setFooter('© Paradise Bots | 2020', 'https://i.imgur.com/Df2seyl.png')

            message.author.send(embed5).then(() => message.channel.send(sent)).catch(() => message.channel.send(cant))
            ...
            embed7.setTimestamp()
            embed7.setFooter('© Paradise Bots | 2020', 'https://i.imgur.com/Df2seyl.png')

            message.author.send(embed7).then(() => message.channel.send(sent)).catch(() => message.channel.send(cant))
            ...
            embed8.setTimestamp()
            embed8.setFooter('© Paradise Bots | 2020', 'https://i.imgur.com/Df2seyl.png')

            message.author.send(embed8).then(() => message.channel.send(sent)).catch(() => message.channel.send(cant))
            ...
            embed6.setTimestamp()
            embed6.setFooter('© Paradise Bots | 2020', 'https://i.imgur.com/Df2seyl.png')

            message.author.send(embed6).then(() => message.channel.send(sent)).catch(() => message.channel.send(cant))
